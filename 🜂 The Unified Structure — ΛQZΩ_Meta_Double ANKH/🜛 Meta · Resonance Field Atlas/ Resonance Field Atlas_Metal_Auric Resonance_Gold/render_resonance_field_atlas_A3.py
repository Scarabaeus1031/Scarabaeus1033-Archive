...
def title_page(pp, figsize):
    ...
    ax.text(0.5, 0.68, "A Visual Synthesis of Light, Resonance & Conscious Geometry", ha="center", va="center", fontsize=14, fontname="DejaVu Serif", style="italic", color="#92400e")
...
def main():
    build("/mnt/data/Resonance_Field_Atlas_A3.pdf", (11.69,16.54))
